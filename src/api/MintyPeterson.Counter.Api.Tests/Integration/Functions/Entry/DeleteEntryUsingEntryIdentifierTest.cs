// <copyright file="DeleteEntryUsingEntryIdentifierTest.cs" company="Tom Cook">
...
namespace MintyPeterson.Counter.Api.Tests.Integration.Functions.Entry
{
  ...
  /// <summary>
  /// Tests if the user can delete an existing entry by specifying the entry identifier.
  /// </summary>
  public class DeleteEntryUsingEntryIdentifierTest : IntegrationTest
  {
    /// <summary>
    ...
    /// </summary>
    private EntryDeleteResponse? responseContent;

    /// <summary>
    /// Initializes a new instance of the <see cref="DeleteEntryUsingEntryIdentifierTest"/> class.
    /// </summary>
    /// <param name="fixture">A <see cref="CounterWebApplicationFactory"/>.</param>
    public DeleteEntryUsingEntryIdentifierTest(CounterWebApplicationFactory fixture)
      : base(fixture)
    {
    }
    ...
    private async Task SendRequestAsync()
    {
      ...
      this.response =
        await this.Client.DeleteAsync("/Entry/00000000-0000-0000-0000-000000000001");

      if (this.response.IsSuccessStatusCode)
      {
        this.responseContent =
          await this.response.Content.ReadFromJsonAsync<EntryDeleteResponse>();
      }
    }
  }
}
