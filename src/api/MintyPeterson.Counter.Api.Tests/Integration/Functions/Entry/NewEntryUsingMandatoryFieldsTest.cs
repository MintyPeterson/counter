// <copyright file="NewEntryUsingMandatoryFieldsTest.cs" company="Tom Cook">
...
namespace MintyPeterson.Counter.Api.Tests.Integration.Functions.Entry
{
  ...
  /// <summary>
  /// Tests if the user can create a new entry using only mandatory fields.
  /// </summary>
  public class NewEntryUsingMandatoryFieldsTest : IntegrationTest
  {
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="NewEntryUsingMandatoryFieldsTest"/> class.
    /// </summary>
    /// <param name="fixture">A <see cref="CounterWebApplicationFactory"/>.</param>
    public NewEntryUsingMandatoryFieldsTest(CounterWebApplicationFactory fixture)
      : base(fixture)
    {
    }
