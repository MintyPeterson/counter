// <copyright file="EditEntryWithNotesTest.cs" company="Tom Cook">
...
namespace MintyPeterson.Counter.Api.Tests.Integration.Functions.Entry
{
  ...
  /// <summary>
  /// Tests if the user can edit an existing entry while including entry notes.
  /// </summary>
  public class EditEntryWithNotesTest : IntegrationTest
  {
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="EditEntryWithNotesTest"/> class.
    /// </summary>
    /// <param name="fixture">A <see cref="CounterWebApplicationFactory"/>.</param>
    public EditEntryWithNotesTest(CounterWebApplicationFactory fixture)
      : base(fixture)
    {
    }
