// <copyright file="EditEntryUsingMandatoryFieldsTest.cs" company="Tom Cook">
...
namespace MintyPeterson.Counter.Api.Tests.Integration.Functions.Entry
{
  ...
  /// <summary>
  /// Tests if the user can edit an existing entry using only mandatory fields.
  /// </summary>
  public class EditEntryUsingMandatoryFieldsTest : IntegrationTest
  {
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="EditEntryUsingMandatoryFieldsTest"/> class.
    /// </summary>
    /// <param name="fixture">A <see cref="CounterWebApplicationFactory"/>.</param>
    public EditEntryUsingMandatoryFieldsTest(CounterWebApplicationFactory fixture)
      : base(fixture)
    {
    }
