// <copyright file="NewEntryWithNotesTest.cs" company="Tom Cook">
...
namespace MintyPeterson.Counter.Api.Tests.Integration.Functions.Entry
{
  ...
  /// <summary>
  /// Tests if the user can create a new entry while including entry notes.
  /// </summary>
  public class NewEntryWithNotesTest : IntegrationTest
  {
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="NewEntryWithNotesTest"/> class.
    /// </summary>
    /// <param name="fixture">A <see cref="CounterWebApplicationFactory"/>.</param>
    public NewEntryWithNotesTest(CounterWebApplicationFactory fixture)
      : base(fixture)
    {
    }
