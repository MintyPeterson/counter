// <copyright file="EntryDeleteHandlerTest.cs" company="Tom Cook">
...
namespace MintyPeterson.Counter.Api.Tests.Unit.Policies
{
  ...
  /// <summary>
  /// Provides tests for <see cref="EntryDeleteHandler"/>.
  /// </summary>
  public class EntryDeleteHandlerTest
  {
    /// <summary>
    ...
    /// </summary>
    private readonly EntryDeleteRequest defaultResource;

    /// <summary>
    /// Initializes a new instance of the <see cref="EntryDeleteHandlerTest"/> class.
    /// </summary>
    public EntryDeleteHandlerTest()
    {
      ...
      this.defaultResource = new EntryDeleteRequest { EntryId = Guid.NewGuid() };
    }
    ...
    public async void ShouldSucceedWhenEntryDoesNotExist()
    {
      var context = new AuthorizationHandlerContext(
        new List<IAuthorizationRequirement> { new EntryDeleteRequirements() },
        this.defaultUser,
