// <copyright file="EntryEditHandler.cs" company="Tom Cook">
...
namespace MintyPeterson.Counter.Api.Policies
{
  ...
  /// <summary>
  /// Provides a <see cref="AuthorizationHandler{EntryEditRequirements}"/>.
  /// </summary>
  public class EntryEditHandler
    : AuthorizationHandler<EntryEditRequirements, EntryEditRequest>
  {
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="EntryEditHandler"/> class.
    /// </summary>
    /// <param name="storageService">An <see cref="IStorageService"/>.</param>
    /// <param name="mapperService">An <see cref="IMapper"/>.</param>
    public EntryEditHandler(IStorageService storageService, IMapper mapperService)
    {
    ...
    protected override Task HandleRequirementAsync(
      ...
      EntryEditRequirements requirement,
      EntryEditRequest resource)
    {
